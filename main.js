...
const LiveScoreCard = document.querySelector('.real-time-score');
const LiveScore = document.getElementsByClassName('real-score');
...
function gameOver() {
    ...
    if (alienTop > 400) {
        ...
        LiveScoreCard.style.display = 'none';
        counter = 0;
        gameOverSound.play();
